    ...
    public class LeaveTypesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            catch (AutoMapperMappingException ex)
            {
                ...
                if (ex.Types is { } t) Console.WriteLine($"SRC: {t.SourceType}, DEST: {t.DestinationType}");
                throw;
            }
        }
        ...
        public async Task<IActionResult> Edit(int id, LeaveTypeEditVM leaveTypeEdit)
        {
            ...
            if (await CheckIfLeaveTypeNameExists(leaveTypeEdit))
            {
        ...
        private async Task<bool> CheckIfLeaveTypeNameExists(LeaveTypeEditVM leaveTypeEdit)
        {
